...
export default function AdminNewListing() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log('Submitting room creation...', formData);
      const response = await api.admin.createRoom(formData);
      console.log('Room creation response:', response);
      
      if (response.success) {
        // Don't reset loading state - let it stay true until navigation completes
    ...
    <div className="space-y-6">
      <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-gray-600">Add a new room listing for a host</p>
          </div>
        </div>
            ...
            <CardContent className="space-y-4">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1">
                  Paste the Google Maps share link for the property location.
                </p>
              </div>
